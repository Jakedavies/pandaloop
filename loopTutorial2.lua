...
function loadNext()
    audio.stop(1)
    composer.gotoScene( "loopTutorial3", { effect="crossFade", time=500 } )
end
...
function scene:create(event)
    ...
    button3: setLabel("And the stuff in the middle?")
    ...
    button4: setLabel("What about those semicolons?")
...
function scene:show( event )
    ...
    local message =  display.newText(" They are very simple. No fear here! \n Let's break it down: \n for(int i = 0; -- Here we declare a variable i initialized to 0. \n i < 10 -- This will loop until i is no longer less than ten. \n i++ )-- Our variable i increases by one each loop.", display.contentCenterX + 5, display.contentCenterY + 115,  native.systemFontBold, 10)
