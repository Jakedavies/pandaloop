...
function loadNextMC()
    composer.gotoScene( "MCCheck2", { effect="crossFade", time=500 } )
end
...
function scene:create(event)
    ...
    speech = display.newImage('assets/sprites/comic-2.png')
      ...
      speech.xScale = -1
      speech.y =  display.contentCenterY +100
      speech.height = 100
      speech.width = 290
      speechx= speech.x
    ...
    buttonBackground.y = display.contentCenterY - 130
    buttonBackground.width = display.contentWidth
    buttonBackground.height = 140
    ...
    button:addEventListener("tap", loadNextMC)

     buttonBackground2 = display.newImage("assets/sprites/touch.png");
    buttonBackground2.x = display.contentCenterX
    buttonBackground2.y = display.contentCenterY -10
    buttonBackground2.width = display.contentWidth
    buttonBackground2.height = 140

    button2 = widget.newButton()
    button2: setLabel("for[var k : k > 10 : k+]{ \n youMayPass(); \n}")
    button2: setEnabled(true)
    button2.x = display.contentCenterX
    button2.y = display.contentCenterY - 10
...
function scene:show( event )
    ...
    local message =  display.newText(" Alrighty then if you're so smart, click on the correct \n for loop then and I will let you face the panda. \n Seriously though I'm asking. I forgot and I need to know. \n  ", display.contentCenterX + 5, display.contentCenterY + 100,  native.systemFontBold, 10)
