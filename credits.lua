...
function scene:show( event )
    ...
    local authors =  display.newText("Authors: \n Nolan Koriath\n Jake Davies", display.contentCenterX, display.contentCenterY-70, "/fonts/Pacifico.ttf", 20)
    authors:setFillColor(0, 0, 0 )
    sceneGroup:insert(authors)

    local t1 = display.newText("Assets", display.contentCenterX, display.contentCenterY, "/fonts/Pacifico.ttf", 20)
    local t2 =display.newText("Button Texture. Author: Arnaud de Saint Mloir \n\t Modifications: Removed Text", display.contentCenterX, display.contentCenterY+45, "/fonts/Pacifico.ttf", 12)
    ...
    local t4 =display.newText("Credit Music. Author: Jan123 - opengameart.com", display.contentCenterX, display.contentCenterY+130, "/fonts/Pacifico.ttf", 12)
