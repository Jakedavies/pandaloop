...
function scene:create(event)
    ...
    button3: setLabel("Alright! I am ready to face the panda!")
...
function scene:show( event )
    ...
    local message =  display.newText("Never modify your variable inside the loop! \n Also, remember that if you declare a different \n variable inside of the loop, it happens every loop. \n Finally, remember that variables \n declared inside the loop are scoped to the loop. \n They are not accessible outside of it. ", display.contentCenterX + 5, display.contentCenterY + 80,  native.systemFontBold, 10)
