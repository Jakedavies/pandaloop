...
function scene:create(event)
    ...
    buttonBackground.width = 290
    sceneGroup:insert(buttonBackground)

    
    button = widget.newButton()
    button: setLabel("Transdimensional Panda. Got it.")
...
function scene:show( event )
    ...
    local message =  display.newText("The panda is a transdimensional being \n who seeks to destroy our world. \nThe only way to catch him, is to trap him in a loop. ", display.contentCenterX + 5, display.contentCenterY + 40,  native.systemFontBold, 10)
