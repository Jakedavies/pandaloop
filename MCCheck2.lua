...
function loadNextMC()
    composer.gotoScene( "MCCheck3", { effect="crossFade", time=500 } )
end
...
function scene:create(event)
    ...
    button: setLabel("for(int i = 0; i < 10; i ++){ \n doWizardStuff(); \n arrivePrecisleyWhenIMeanTo(); \n i -= 1; \n inventory[i] = i+1; \n}")
    ...
    buttonBackground2.width = display.contentWidth
    buttonBackground2.height = 50

    button2 = widget.newButton()
    button2: setLabel("for(int i = 0; i < 10; i ++){")
    button2: setEnabled(true)
    button2.x = display.contentCenterX
    button2.y = display.contentCenterY - 80
    button2:addEventListener("tap", loadTutorial3)
    ...
    button3: setLabel("doWizardStuff();")
    button3: setEnabled(true)
    button3.x = display.contentCenterX
    button3.y = display.contentCenterY - 35
    button3:addEventListener("tap", loadTutorial3)
    ...
    button4: setLabel("arrivePrecisleyWhenIMeanTo();")
    button4: setEnabled(true)
    button4.x = display.contentCenterX
    button4.y = display.contentCenterY + 10
    button4:addEventListener("tap", loadTutorial3)

    buttonBackground5 = display.newImage("assets/sprites/touch.png");
    buttonBackground5.x = display.contentCenterX
    buttonBackground5.y = display.contentCenterY + 55
    buttonBackground5.width = display.contentWidth
    buttonBackground5.height = 50

    button5 = widget.newButton()
    button5: setLabel(" i -= 1;")
    button5: setEnabled(true)
    button5.x = display.contentCenterX
    button5.y = display.contentCenterY + 55
    button5:addEventListener("tap", loadNextMC)
    ...
    sceneGroup:insert(button4)
     sceneGroup:insert(buttonBackground5)
...
function scene:show( event )
    ...
    local message =  display.newText(" You seem pretty smart. My wizard homework is hard. \n not that I am getting you to do it for me...  \n Wizards never usually lie. \n Which line is wrong in this for loop? \n Last one before the panda I promise. ", display.contentCenterX + 5, display.contentCenterY + 115,  native.systemFontBold, 10)
